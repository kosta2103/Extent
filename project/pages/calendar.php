        ...
        <div class="col-md-3">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Događaji</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
              <div id="external-events">
                <div class="external-event bg-green">Sastanak</div>
                <div class="external-event bg-yellow">Početak projekta</div>
                <div class="external-event bg-aqua">Kraj projekta</div>
                <div class="external-event bg-light-blue">Isporuka projekta</div>
                <div class="external-event bg-red">Ugovaranje projekta</div>
                <div class="checkbox">
                  <label for="drop-remove">
                    <input type="checkbox" id="drop-remove">
                    ukloni nakon otpuštanja
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Kreiraj dogadjaj</h3>
            </div>
            <div class="box-body">
...
<script>
  $(function () {
    ...
    $('#calendar').fullCalendar({
      ...
      events    : [
        {
          title          : 'Sastanak sa predstavnicima Extenta',
        ...
        {
          title          : 'Isporuka projekta za BWF',
        ...
        {
          title          : 'Sastanak sa podizvođačima',
        ...
        {
          title          : 'Kraj projekta za Proenergy',
