            ...
            <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Unesite ime" name="fname" value="<?php $_POST['hidden_field_fname'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Prezime</label>
                  <input type="text" class="form-control" id="exampleInputLastName" placeholder="Unesite prezime" name="lname" value="<?php $_POST['hidden_field_lname'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Korisničko ime</label>
                  <input type="text" class="form-control" id="exampleInputUsername" placeholder="Unesite korisničko ime" name="username" value="<?php $_POST['hidden_field_username'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Mejl</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Unesite mejl" name="mail" value="<?php $_POST['hidden_field_email'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Šifra</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Unesite šifru" name="passwd" value="<?php $_POST['hidden_field_password'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Broj telefona</label>
                  <input type="text" class="form-control" id="exampleInputNumber" placeholder="Unesite broj telefona" name="phonenum" value="<?php $_POST['hidden_field_phone'];?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputFile">Profilna slika</label>
                  <input type="file" id="exampleInputFile" name="profilepic" value="<?php $_POST['hidden_field_profile_pic'];?>">
                </div>
                <div class="form-group">
                    <label>Role</label>
                    <select class="form-control select2" style="width: 100%;" name="role" value="<?php $_POST['hidden_field_role_name'];?>">
                      <option>Admin</option>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputProffession" placeholder="Unesite naziv profesije" name="profession" value="<?php $_POST['hidden_field_profession'];?>">
                </div>
              </div>
              <!-- /.box-body -->
